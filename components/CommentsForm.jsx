    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
            ...
            <div className='grid grid-cols-1 gap-4 mb-4'>
                <textarea
                    ref={commentEl}
                    className='p-4 oultine-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700'
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4'>
                <input type="text" ref={nameEl}
                    className='py-2 px-4 oultine-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700'
                    placeholder='Nombre'
                    name='name'
                />
            ...
            <div className='grid grid-cols-1 gap-4 mb-4'>
                <div>
                    ...
                    <label className='text-gray-500 cursor-pointer ml-2' htmlFor='storeData'>Guardar mi nombre y correo para futuros comentarios</label>
                </div>
            </div>
            {error && <p className='text-xs text-red-500'>Debe rellenar todos los campos</p>}
            <div className='mt-8'>
                <button
                    type='button'
